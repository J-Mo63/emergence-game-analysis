...
exp.correlation_matrix(param_df, 'Summary Stat Correlation Matrix', exclude_features=['tree_spawn_rate', 'tree_health', 'food_spawn_rate', 'food_health', 'plant_growth_rate', 'dude_speed', 'dude_max_hunger', 'dude_lifespan', 'wraith_speed', 'quarry_health', 'building_max_health'])